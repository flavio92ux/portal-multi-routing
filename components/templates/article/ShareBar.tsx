...
export function ShareBar() {
  return (
    <div className="flex items-center justify-between border-y border-[#dee2e7] py-3">
      <span className="text-sm font-bold text-[#1d1d1d]">Compartilhar</span>
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className="flex h-8 w-8 items-center justify-center rounded-full bg-[#0075ff] text-white transition-opacity hover:opacity-80"
        >
