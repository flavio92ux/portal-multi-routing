      ...
      <div className="mb-8 flex items-center border-y border-gray-100 py-6">
        ...
        <div className="text-sm">
          ...
          <p className="text-gray-500">
            {new Date(content.dates.published_at).toLocaleDateString('pt-BR')}{' '}
            às{' '}
            {new Date(content.dates.published_at).toLocaleTimeString('pt-BR', {
              hour: '2-digit',
              minute: '2-digit',
            })}
          </p>
            ...
            case 'quote':
              return (
                ...
                >
                  ...
                  <cite className="mt-2 block text-sm">— {block.author}</cite>
                </blockquote>
              );
            case 'image':
              return (
